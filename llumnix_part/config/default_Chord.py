...
# Request redispatch policy
_C.MANAGER.REDISPATCH_POLICY = 'load'
# Number of candidate instances for dispatch policy
_C.MANAGER.TOPK_RANDOM_DISPATCH = 1
# Redispatch threshold
_C.MANAGER.REDISPATCH_THRESHOLD = 1.0

# -------------------------- MIGRATION CONFIGURATION --------------------------
# Enable migrate requests between instances
_C.MANAGER.ENABLE_MIGRATION = False
# Eanble prefill request rerouting
_C.MANAGER.ENABLE_REROUTING = False
...
# Instance redispatch load metric
_C.INSTANCE.REDISPATCH_LOAD_METRIC = 'remaining_steps'
