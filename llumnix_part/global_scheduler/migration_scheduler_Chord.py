...
class MigrationScheduler:
    def __init__(self, pair_migration_policy: str,
        ...
        self.redispatch_policy = PairMigrationPolicyFactory.get_policy('urgency', \
    ...
    def get_redispatch_src_instances(self):
        return self.redispatch_policy.get_src_instances(self.instance_info.values())

    def get_redispatch_dst_instance(self, src_instance_id, target_request):
        return self.redispatch_policy.get_dst_instance(self.instance_info.values(), src_instance_id, target_request)
    ...
    def pair_migration_reroute(self, pair_migration_type: PairMigrationConstraints) -> List[Tuple[str, str]]: 
        # The logic here is to find the src instance with the maximum pending time.
        # The dst instance is not yet determined.
        return self.pair_migration_policy_reroute.pair_migration(self.instance_info.values(), self.instance_info.values())
